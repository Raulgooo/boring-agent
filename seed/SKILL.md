---
name: seed
description: Typed project incubator - guided ideation through graduation into buildable projects. Use when starting or shaping a new project, when a vague idea needs planning, when graduating or launching an ideated project, when checking project ideation status, when adding a custom project type, or when the user invokes /seed, /seed graduate, /seed launch, /seed status, or /seed add-type.
---
